pub fn run() {
    ...
    println!("Heap memory addres of hello is: {:?}", s3.as_ptr());
    println!("Heap memory addres of hello is: {:?}", s4.as_ptr());
    println!("{} {}", s3, s4);

    let s5 = String::from("hello");
    println!("Stack address of s5 is: {:p}", &s5);
    println!("Heap memory addres of s5 is: {:?}", s5.as_ptr());
    ...
    println!("Heap memory addres of s6 is: {:?}", s6.as_ptr());
    ...
    println!("Heap memory addres of s7 is: {:?}", s7.as_ptr());
...
fn take_ownership(s: String) {
    ...
    println!("Heap memory addres of s is: {:?}", s.as_ptr());
